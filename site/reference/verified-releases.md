...
```sh
gh attestation verify parley-protocol-0.1.0.tgz --repo yea-protocol/yea
gh attestation verify parley_protocol-0.1.0-py3-none-any.whl --repo yea-protocol/yea
```
